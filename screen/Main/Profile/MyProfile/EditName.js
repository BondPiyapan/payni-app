        ...
        return (
            <View style={styles.container}>
                <View style={{ padding: 20 }}>
                    <TextInput
                        placeholder={'ชื่อเล่นควรมี 10 ตัวอักษร'}
                    ...
                    <TouchableOpacity style={{ backgroundColor: '#03DAC6', padding: 8, width: width * .9, alignItems: 'center', borderRadius: 5, marginTop: 20 }}>
