    ...
    render() {
        return (
            ...
            <Images
              ...
              <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), color: '#000' }}> PayNi ******</Text>
              </View>
              <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), color: '#999', textAlign:'center' }}>การยืนยันตัวตนด้วยรูปภาพเสร็จสมบูรณ์ คุณสามารถใช้บริการบัญชี PayNi ได้ทันที!</Text>
            </View>
        </View>
        );
    }
