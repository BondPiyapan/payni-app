...
export default class MainAddressbook extends React.Component {
            ...
            <View style={styles.container}>
                <View style={{ padding: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems:'center'}}>
                        <Text style={{ fontFamily: 'sukhumvit-set-bold', fontSize: hp('2%') }}>PayNi  </Text>
                        <Icon.AntDesign name="home" size={hp('2%')} color="#03DAC6" />
                        <View style={{ position: 'absolute', right: hp('1%'),}}>
                        <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%') }}>0812345678</Text>
                        </View>
                    </View>
                    <View style={{marginTop: 5}}>
                    <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%') }}>142 อาคาร ทู แปซิฟิคเพลส ชั้น 23 ถ.สุขุมวิท แขวงคลองเตย เขตคลองเตย กรุงเทพมหานคร 10110</Text>
                    </View>
                </View>
                ...
                <View style={{alignItems:'center', position:'absolute', bottom: 0, right:0, left: 0}}>
                    ...
                    style={{ backgroundColor: '#03DAC6', padding: 8, width: width * .9, alignItems: 'center', borderRadius: 5, marginBottom: 20 }}>
                        <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), color: '#fff' }}>Add Address</Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
