...
export default class MainSecurityAccount extends React.Component {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View>
            <TouchableOpacity 
              ...
              <View style={{ flexDirection: 'column' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), marginLeft: hp('3%') }}>เบอร์โทรศัพท์</Text>
              </View>
              <View style={{ marginLeft: hp('3%'), position: 'absolute', right: hp('2%'), flexDirection:'row', alignItems:'center' }}>
              <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), marginLeft: hp('3%'), color: '#999' }}>********78</Text>
          ...
          <View>
            <TouchableOpacity
              style={{ width: width, alignItems: 'center', flexDirection: 'row', paddingVertical: 15 }}>
              <View style={{ flexDirection: 'column' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), marginLeft: hp('3%') }}>วงเงินจำกัดต่อวัน</Text>
              </View>
              <View style={{ marginLeft: hp('3%'), position: 'absolute', right: hp('2%'), flexDirection:'row', alignItems:'center' }}>
              <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), marginLeft: hp('3%'), color: '#999' }}>100,000.00</Text>
              <Icon.Entypo name="chevron-small-right" size={hp('4.5%')} color="#ccc" />
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View>
            <TouchableOpacity 
              style={{ width: width, alignItems: 'center', flexDirection: 'row', paddingVertical: 15 }}>
              <View style={{ flexDirection: 'column' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), marginLeft: hp('3%') }}>ตั้งค่ารหัสผ่าน</Text>
              </View>
              <View style={{ marginLeft: hp('3%'), position: 'absolute', right: hp('2%'), flexDirection:'row', alignItems:'center' }}>
              <Icon.Entypo name="chevron-small-right" size={hp('4.5%')} color="#ccc" />
              </View>
          ...
          <View>
            <TouchableOpacity 
              ...
              />
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%') }}>  คำแนะนำเพื่อความปลอดภัย</Text>
              </View>
              <View style={{ marginLeft: hp('3%'), position: 'absolute', right: hp('2%'), flexDirection:'row', alignItems:'center' }}>
              <Icon.Entypo name="chevron-small-right" size={hp('4.5%')} color="#ccc" />
              </View>
