  ...
  render() {
    return (
      <View style={styles.container}>
          <View>
            <TouchableOpacity 
              ...
              <View style={{ flexDirection: 'column' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%'), marginLeft: hp('3%') }}>นโยบายความเป็นส่วนตัว</Text>
              </View>
          ...
          <View>
            <TouchableOpacity 
              ...
              <View style={{ flexDirection: 'row', marginLeft: hp('3%'), justifyContent:'center' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%') }}>เงื่อนไขการให้บริการ</Text>
              </View>
              <View style={{ marginLeft: hp('3%'), position: 'absolute', right: hp('2%'), flexDirection:'row', alignItems:'center' }}>
              <Icon.Entypo name="chevron-small-right" size={hp('4.5%')} color="#ccc" />
              </View>
          ...
          <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.2%') }}>เวอร์ชั่น {appjson.expo.version}</Text>
            </View>
      </View>
    );
  }
