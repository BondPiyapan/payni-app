                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableOpacity style={{ padding: 20 }}>
                        <View style={{ marginTop: 10 }}>
                            <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%') }}>การไฟฟ้าส่วนภูมิภาคปิดให้บริการชั่วคราวทำให้ไม่สามารถจ่ายบิลได้ ขอภัยในความไม่สะดวก</Text>
                    ...
                    <TouchableOpacity style={{ padding: 20 }}>
                        <View style={{ marginTop: 10 }}>
                            <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%') }}>การไฟฟ้าส่วนภูมิภาคจะปิดให้บริการซ่อมแซมระบบคืนนี้(7 สิงหาคม) เวลา 20.00 - 24.00 น. ทำให้ไม่สามารถจ่ายบิลได้ในช่วงเวลาดังกล่าว</Text>
                            <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('1.8%'), color: '#ccc' }}>21/12/2563 11:34</Text>
                        </View>
                    </TouchableOpacity>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%'), marginHorizontal: 20 }} />
