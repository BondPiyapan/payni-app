...
export default class MainTransfer extends React.Component {
    ...
    return (
      <View style={styles.container}>
        <View style={{
          ...
          <View>
            <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTransfer')}
              style={{ width: width, alignItems: 'center', flexDirection: 'row', padding: 12 }}>
              <Images
                width={width * .1}
                source={require('../../../../../assets/images/icon_bank/address-book.png')}
              />
              <View style={{ flexDirection: 'column' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('1.8%'), marginLeft: hp('3%') }}>ไปยังเบอร์โทรศัพท์ หรือ ID PayNi</Text>
              </View>
          ...
          <View>
            <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTransferBank')}
              style={{ width: width, alignItems: 'center', flexDirection: 'row', padding: 12 }}>
              <Images
                width={width * .1}
                source={require('../../../../../assets/images/icon_bank/cards.png')}
              />
              <View style={{ flexDirection: 'column' }}>
                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('1.8%'), marginLeft: hp('3%') }}>ไปยังบัญชีธนาคาร</Text>
              </View>
              <Icon.Entypo style={{ marginLeft: hp('3%'), position: 'absolute', right: hp('2%') }} name="chevron-small-right" size={hp('4.5%')} color="#ccc" />
            </TouchableOpacity>
          </View>
