...
export default class CheckOutTranster extends React.Component {
        ...
        return (
            <View style={styles.container}>
                ...
                <View
                        ...
                        <Text style={{ fontFamily: 'sukhumvit-set-bold', fontSize: hp('2%'), }}>โอนเงินให้กับ</Text>
                            <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.8%'), marginLeft: hp('3%') }}>PayNi01</Text>
                        </View>
                    </View>
