...
export default class MainTopupMobile extends React.Component {
        ...
        return (
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View>
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTopupMobile', {type: 'AIS'})}
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>AIS 1-2-Call!</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTopupMobile', {type: 'DTAC'})}
                            style={{ width: width, alignItems: 'center', flexDirection: 'row', padding: 10, marginLeft: 10 }}>
                            <Images
                                width={width * .1}
                            ...
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>Dtac Prepaid</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTopupMobile', {type: 'TRUE'})}
                            style={{ width: width, alignItems: 'center', flexDirection: 'row', padding: 10, marginLeft: 10 }}>
                            <Images
                                width={width * .1}
                            ...
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>TrueMove H</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTopupMobile', {type: 'PEN'})}
                            style={{ width: width, alignItems: 'center', flexDirection: 'row', padding: 10, marginLeft: 10 }}>
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_topup/penguin-01.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>Penguin</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate('DetailTopupMobile', {type: 'CAT'})}
                            style={{ width: width, alignItems: 'center', flexDirection: 'row', padding: 10, marginLeft: 10 }}>
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_topup/cat-01.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>CAT</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
