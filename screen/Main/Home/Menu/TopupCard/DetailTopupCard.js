...
export default class DetailTopupCard extends React.Component {
    ...
    check(item) {
            this.props.navigation.navigate('CheckOutTopupCard',{type: type, price: item.price})
    }
    ...
    render() {
        const data = [
            ...
            { price: '100', displayprice: 'ชำระ ฿10.00', value: 'ชำระ ฿10.00' },
            ...
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ padding: 20 }}>
                        <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), }}>กรุณาเลือกบัตรเติมเงิน</Text>
