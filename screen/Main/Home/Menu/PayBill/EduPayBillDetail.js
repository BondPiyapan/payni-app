...
export default class EduPayBillDetail extends React.Component {
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_edu/1.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>มหาวิทยาลัยกรุงเทพ</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_edu/2.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>จุฬาลงกรณ์มหาวิทยาลัย</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_edu/3.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>มหาวิทยาลัยธรรมศาสตร์</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_edu/4.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>มหาวิทยาลัยขอนแก่น</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_edu/5.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>มหาวิทยาลัยธุรกิจบัณฑิตย์</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
