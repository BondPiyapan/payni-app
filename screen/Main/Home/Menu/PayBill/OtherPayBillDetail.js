...
export default class OtherPayBillDetail extends React.Component {
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_paybill/other/1.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>โคเวย์</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_paybill/other/2.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>มิสทิน</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_paybill/other/3.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>มิสทิน เอ็มพาวเวอร์</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_paybill/other/4.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>Ocha</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
