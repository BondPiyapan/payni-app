...
export default class InsurePayBillDetail extends React.Component {
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_insure/1.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>กรุงเทพประกันชีวิต</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_insure/2.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>กรุงเทพประกันภัย</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_insure/3.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>ทิพยประกันภัย</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_insure/4.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>ไทยวิวัฒน์</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
                    <View>
                        <TouchableOpacity
                            ...
                            <Images
                                width={width * .1}
                                source={require('../../../../../assets/images/icon_insure/5.png')}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2%'), marginLeft: hp('3%') }}>เอไอเอ</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 1, backgroundColor: '#CED7DE', marginBottom: hp('1%') }} />
