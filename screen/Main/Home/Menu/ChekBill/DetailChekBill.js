...
export default class DetailChekBill extends React.Component {
    ...
    return (
      <View style={styles.container}>
        <View style={{ padding: 10 }}>
          ...
          <Text style={{ fontFamily: 'sukhumvit-set-bold', fontSize: hp('2%'), marginVertical: hp('2%')  }}>ผู้ถูกเรียกเก็บเงิน</Text>
          <TextInput
        ...
        <View style={{alignItems:'center', position: 'absolute', bottom:0, right:0, left:0}}>
                    ...
                    :
                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('CompleteChekBilly')}
