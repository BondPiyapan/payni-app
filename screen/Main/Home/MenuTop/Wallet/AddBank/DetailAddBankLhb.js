...
export default class DetailAddBankLhb extends React.Component {
        ...
        return (
            <View style={styles.container}>
                <View style={{ alignItems: 'center', padding: 20 }}>
                    <View style={{ width: width * .9, height: hp('28%'), backgroundColor: '#136DD5', borderRadius: 10, alignItems: 'flex-start', justifyContent: 'center' }}>
                        <View
