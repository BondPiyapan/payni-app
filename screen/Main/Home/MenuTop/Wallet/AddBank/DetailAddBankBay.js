...
export default class DetailAddBankBay extends React.Component {
        ...
        return (
            <View style={styles.container}>
                <View style={{ alignItems: 'center', padding: 20 }}>
                    <View style={{ width: width * .9, height: hp('28%'), backgroundColor: '#FDD600', borderRadius: 10, alignItems: 'flex-start', justifyContent: 'center' }}>
                        <View
                            ...
                            <View style={{ marginLeft: hp('2%'), alignItems: 'flex-start', }}>
                                <Text style={{
                                    ...
                                    textAlign: 'center'
                                }}>ธนาคารกรุงศรีอยุธยา</Text>
                                <Text style={{
                                    color: '#fff',
                                    fontSize: hp('1.8%'),
                                    fontFamily: 'sukhumvit-set',
                                    textAlign: 'center'
                                }}>BANK OF AYUDHYA</Text>
                            </View>
                        </View>
                        <Text style={{
                            marginLeft: hp('7%'),
