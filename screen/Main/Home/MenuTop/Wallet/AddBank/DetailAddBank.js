...
export default class DetailAddBank extends React.Component {
        ...
        return (
            <View style={styles.container}>
                <View style={{ alignItems: 'center', padding: 20 }}>
                    <View style={{ width: width * .9, height: hp('28%'), backgroundColor: '#9021D4', borderRadius: 10, alignItems: 'flex-start', justifyContent: 'center' }}>
                        <View
                            ...
                            <View style={{ marginLeft: hp('2%'), alignItems: 'flex-start', }}>
                                <Text style={{
                                    ...
                                    textAlign: 'center'
                                }}>ธนาคารไทยพาณิชย์</Text>
                                <Text style={{
                                    color: '#fff',
                                    fontSize: hp('1.8%'),
                                    fontFamily: 'sukhumvit-set',
                                    textAlign: 'center'
                                }}>SAIM COMMERCIAL BANK</Text>
                            </View>
                        </View>
                        <Text style={{
                            marginLeft: hp('7%'),
