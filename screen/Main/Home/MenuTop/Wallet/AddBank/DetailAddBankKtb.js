...
export default class DetailAddBankKtb extends React.Component {
        ...
        return (
            <View style={styles.container}>
                <View style={{ alignItems: 'center', padding: 20 }}>
                    <View style={{ width: width * .9, height: hp('28%'), backgroundColor: '#2AA9EE', borderRadius: 10, alignItems: 'flex-start', justifyContent: 'center' }}>
                        <View
