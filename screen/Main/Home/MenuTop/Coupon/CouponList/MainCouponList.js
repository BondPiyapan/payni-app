...
export default class MainCouponList extends React.Component {
            ...
            <View style={styles.container}>
                <View style={{ alignItems: 'center', padding: 20 }}>
                    <View style={{
                        ...
                        <View style={{ flex: 0.9 }}>
                            <TextInput
                                value={this.state.enterCoupon}
                                onChangeText={TextInputValue => this.onEnterText(TextInputValue)}
                                placeholder={'กรอกคูปองโค้ด'}
                                style={{ fontFamily: 'sukhumvit-set', fontSize: hp('2.4%'), marginRight: hp('2%') }}
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{ alignItems: 'center', padding: 20 }}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('DetailCouponList',{typeCoupon: 'active'})} style={{
                            backgroundColor: '#fff',
                            shadowColor: "#000",
                            shadowOffset: {
                                width: 0,
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ flex: 0.3, alignItems: 'flex-end', justifyContent: 'center' }}>
                                    <Text style={{ fontFamily: 'sukhumvit-set', fontSize: hp('1.8%'), color: '#03DAC6' }}>สามารถใช้ได้</Text>
                                </View>
                            </View>
                            <View>
                    ...
                    <View style={{ alignItems: 'center', padding: 20 }}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('DetailCouponList',{typeCoupon: 'active'})}
                            style={{
                                backgroundColor: '#fff',
                                shadowColor: "#000",
                                shadowOffset: {
